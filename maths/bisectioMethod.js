/**
 Given a function f(x) and an interval [a, b], where f(a) * f(b) < 0, find an approximation of the root
 ...
 */
 ...
 const getRoot = (a, b, func, numberOfIterations) => {
    ...
    if (prod1 > 0 && prod2 < 0) return getRoot(m, b, func, --numberOfIterations)
    else if (prod1 < 0 && prod2 > 0) return getRoot(a, m, func, --numberOfIterations)
